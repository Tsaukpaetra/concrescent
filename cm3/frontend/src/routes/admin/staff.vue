    ...
    <v-tabs-items :value="subTabIx" touchless>
        <v-tab-item value="0">
            <badgeSearchList apiPath="Staff/Badge" context_code="S" :AddHeaders="listAddHeaders"
                ...
                <template v-slot:[`item.__assigned_positions`]="{ item }">

                    <v-toolbar dense flat color="transparent">
                        <v-chip v-for="(pos, ix) in item.assigned_positions" :key="ix" left>{{
        ...
        <v-tab-item value="3">
            ...
            <v-dialog v-model="dDialog" scrollable>
                ...
                <v-card>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="default" @click="dDialog = false">Cancel</v-btn>
    ...
    data: () => ({
        ...
        eNameTranslation: {
            ...
            'application-Onboarding': {
                text: 'Application Onboarding',
                tip: 'Sent when application enters onboarding phase'
            },
            'application-Active': {
                text: 'Application Completed and active',
                tip: 'Sent when application is complete and staff is Active'
            },
            'application-Terminated': {
                text: 'Application Terminated',
                tip: 'Sent when application is terminated'
            },
        },
